...
if(galleryImages) {
    ...
    image.onclick = function() {
        ...
        var getImgUrlPos = getFullImgUrl.split("/imgGallery/img/");
        ...
        popupImg.appendChild(newImgWindow);//dodaje div u popup
        ...
        newImg.setAttribute("src", "./imgGallery/img/" + setNewUrl);
        ...
        newImg.onload = function() {
            ...
            newNextBtn.style.cssText = "right:" + "200" + "px;";
            ...
            newPrevBtn.style.cssText = "left:" + "220" + "px;";
        }
    }
    });
}
...
function changeImg(changeDir) {
    ...
    if(changeDir === 1) {
        ...
        if(calcNewImg === 0) {
            calcNewImg = 15; //poslednja slika
        }
    }

    newImg.setAttribute("src", "./imgGallery/img/img" + calcNewImg + ".jpg");
    newImg.setAttribute("id", "current-img");
    getLatestOpenedImg = calcNewImg;

    newImg.onload = function() {
        var nextBtn = document.querySelector(".img-btn-next");
        nextBtn.style.cssText = "right:" + "200" + "px;";
        var prevBtn = document.querySelector(".img-btn-prev");
        prevBtn.style.cssText = "left:" + "220" + "px;";
    }
}
